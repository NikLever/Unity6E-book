...
public class DitherEffectFeature : ScriptableRendererFeature
{
    ...
    internal class DitherEffectPass : ScriptableRenderPass
    {
        ...
        private static void ExecuteCopyColorPass(RasterCommandBuffer cmd, RTHandle sampledTexture)
        {
            ...
            {
                Blitter.BlitTexture(cmd, sampledTexture, new Vector4(1, 1, 0, 0), 0.0f, false);
            }
        ...
        private static void ExecuteMainPass(RasterCommandBuffer cmd, Material material, RTHandle sampledTexture)
        {
            ...
            if (sampledTexture != null)
                s_SharedPropertyBlock.SetTexture(m_BlitTextureID, sampledTexture);
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            using (var builder = renderGraph.AddRasterRenderPass<PassData>(m_PassName + "_EffectPass", out var passData, m_Sampler))
            {
